...
import 'package:superapp_mobile/common/fetchAPI.dart';
...
class CreateResearchPage extends StatefulWidget {
  @override
  _CreateResearchPageState createState() => _CreateResearchPageState();
}
...
class _CreateResearchPageState extends State<CreateResearchPage>
  ...
  void repostResearchComponent() {
    for (var selectedComponent in selectedComponents) {
      postResearchComponent(selectedComponent);
    }
    selectedComponents = [];
  }
  ...
  void generateCodeAndWriteNFCTag() {
    ...
    NfcManager.instance.startSession(onDiscovered: (NfcTag tag) async {
      ...
      var nfcCode = '$idCurrentCreated'.codeUnits;
        ...
        return FadeAnimation(
            ...
            Container(
              child: DatePicker(
                ...
                height: 100,
                width: 60,
                initialSelectedDate: DateTime.parse(selectedStartDateResearch),
                selectionColor: const Color(0xFF029456),
                daysCount: DateTime.parse(selectedEndDateResearch)
                    .difference(DateTime.parse(selectedStartDateResearch))
                    .inDays,
